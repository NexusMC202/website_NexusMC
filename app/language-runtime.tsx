...
const dictionary: Record<string,string> = {
  ...
  ,"Эти изображения используются только как визуальные референсы. На них не показаны настоящие города сервера NexusMC. Изображения не принадлежат NexusMC или ForceCore Inc., и проект не заявляет авторских прав на них.":"These images are visual references only. They do not show real NexusMC cities. The images do not belong to NexusMC or ForceCore Inc., and the project claims no copyright to them."
