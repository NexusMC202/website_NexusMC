...
const WINDOWS_EXE_DOWNLOAD = "https://github.com/NexusMC202/website_NexusMC/releases/download/launcher-v0.9.5/NexusLauncher.exe";
const WINDOWS_ZIP_DOWNLOAD = "https://github.com/NexusMC202/website_NexusMC/releases/download/launcher-v0.9.5/NEXUS-Launcher-Portable-v0.9.5.zip";
  ...
  return <main className="download-page">
    ...
    <section className="download-hero">
      ...
      <div className="download-intro">
        ...
        <span>ТЕКУЩАЯ ВЕРСИЯ · 0.9.5</span>
      </div>
    </section>
      ...
      <div className="platform-grid">
        <article className="platform-card available">
          ...
          <div className="windows-download-options">
            <a href={WINDOWS_EXE_DOWNLOAD}>СКАЧАТЬ EXE <b>↓</b><small>v0.9.5 · один файл</small></a>
            <a href={WINDOWS_ZIP_DOWNLOAD}>СКАЧАТЬ ZIP <b>↓</b><small>v0.9.5 · рекомендуется</small></a>
          </div>
        </article>
